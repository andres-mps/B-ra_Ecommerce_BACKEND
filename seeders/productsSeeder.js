...
module.exports = async () => {
  const products = [
    ...
    },
    {
      ...
      stock: 2,
      price: 45,
      image: ["resin_from_the_dead.webp", "resin_from_the_dead-side.webp"],
      featured: false,
      active: true,
      slug: "",
      categoryId: "1",
    ...
    },
    {
      ...
      stock: 7,
      price: 45,
      image: ["SantaGosePastryEdition.webp", "SantaGosePastryEdition-side.webp"],
      featured: false,
      active: true,
      slug: "",
      categoryId: "2",
...

    {
      ...
      stock: 0,
      price: 39,
      image: ["hop-to-mist.webp", "hop-to-mist-side.webp"],
      featured: false,
      active: true,
      slug: "",
      categoryId: "2",
